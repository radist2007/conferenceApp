...
router.post('/', function(req, res) {
    console.log('Incaming POST')
    console.log('/sendMail fomr wos submited');
    ...
    var name = req.body.name,
        ...
        function backToUser(value) {
            return new Promise(function(resolve, reject) {
                ...
                console.log(' MESSAGE_SENDed to me --->>' + credentials.gmail.user );
                console.log(' MESSAGE_SENDed to user --->>' + mail );
            })
        }
        ...
        console.log('trable here ---> try/catch sendMail.js: ' + e);
        console.log('------/sendMailErr');
        res.render('sendMailErr');
    }

    console.log('sendMails code end! But the ->');
});
